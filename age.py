...
class AgeEstimator(object):
    ...
    def get_age_from_faces(self,input_img, bboxs):
        ...
        with torch.no_grad():
            ...
            faces = np.empty((len(bboxs), img_size, img_size, 3))

            if len(bboxs) > 0:
                for i, d in enumerate(bboxs):
                    ...
                    cv2.rectangle(input_img, (x1, y1), (x2, y2), (255, 255, 255), 2)
                    cv2.rectangle(input_img, (xw1, yw1), (xw2, yw2), (255, 0, 0), 2)
